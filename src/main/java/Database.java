...
/**
 * Class to handle interactions with connections to the database
 */
public class Database {
     ...
     * @throws DataAccessException - SQL exception caused in opening connection
     */
    public Connection openConnection() throws DataAccessException {
        try {
            // The Structure for this Connection is driver:language:path
            // The path assumes you start in the root of your project unless given a full file path
            final String CONNECTION_URL = "jdbc:sqlite:CS452.db";
    ...
    /**
     * Closes connection to the database, essential for every time a connection is made
     * @param commit - Whether changes should be committed to the database
     */
